<?php 
	...
	if ($session_role !== 'packaging') {
		header("Location:".BASE_URL);
	}
?>

<body class="packaging">
	
	<?php include_once 'includes/nav.php'; ?>

	<div class="packaging__content mt-5">
			...
			<div class="col md-8-12">
				...
				<div class="col md-8-12">
					<div class="card">
						...
						<div class="card__footer">
							<div class="btn-group">
								<button class="btn btn-green rec-btn sm-1-2" disabled id="prodRecBtn" data-stage="13">Receive at Packaging</button>
								<button class="btn btn-green btn-darker send-btn sm-1-2" disabled id="prodSendBtn" data-stage="14">Send to Customer</button>
							</div>
						</div>
					</div>
				</div>
